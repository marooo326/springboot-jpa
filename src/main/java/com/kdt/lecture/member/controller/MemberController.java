...
public class MemberController {
    ...
    public ApiResponse<Long> updateMember(@PathVariable Long id, @RequestBody MemberDto memberDto) throws NotFoundException {
        Long memberId = memberService.updateMember(id, memberDto);
        return ApiResponse.ok(memberId);
    }

    @GetMapping("/members/{id}")
    public ApiResponse<MemberDto> getMembers(@PathVariable Long id) throws NotFoundException {
